                ...
                <div class="card-body">
                    <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="upsell-items">
                                ...
                                <div class="upsell-item">
                                    ...
                                    <div class="upsell-content">
                                        ...
                                        <ul class="mb-3">
                                            @foreach ($upsell->price_items as $priceItem)
                                                <li>${{ $priceItem['price']}} - {{ $priceItem['description'] }}</li>
                                            @endforeach
                                        </ul>
                        ...
                        <div class="tab-pane fade" id="nav-domains" role="tabpanel" aria-labelledby="nav-domains-tab">
                            <div class="public-event-link">
                                <span class="">@lang('Public event link:')</span> 
                                <a href="{{ $event->getPublicUrl() }}" target="_blank">{{ $event->getPublicUrl() }}</a>
                            </div>
                            <hr>
                        ...
                        var html = `
                            <div class="upsell-item">
                                ...
                                <div class="upsell-content">
                                    <h4 class="upsell-title">${upsell.title}</h4>
                                    <ul class="mb-3">`;
                                    for (price_item of upsell.price_items) {
                                        html += `<li>$${price_item.price} - ${price_item.description}</li>`
                                    }
                                    html += `
                                    </ul>
                                    <div class="upsell-description">${upsell.description}</div>
