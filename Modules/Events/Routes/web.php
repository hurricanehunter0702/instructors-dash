...
Route::group(['prefix' => 'e', 'as' => 'events.public.', ], function(){
    ...
    Route::get('confirm-payment/{id}', 'PublicEventsController@confirmPayment')->name('confirmPayment');
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'events', 'as' => 'events.', ], function(){
        ...
        Route::get('expired', 'EventsController@expired')->name('expired');
        ...
        Route::get("get-guests/{id}", "EventsController@getGuestsByEventId")->name("get_guests");
    ...
    Route::group(['prefix' => 'templates', 'as' => 'templates.'], function () {
        ...
        Route::put('{id}', 'TemplatesController@update')->name('update');
        Route::delete('{id}', 'TemplatesController@destroy')->name('destroy');
    });
	...
	Route::middleware('can:admin')->prefix('settings')->name('settings.')->group(function () {
        Route::group(['prefix' => 'events', 'as' => 'events.', ], function(){
            ...
            Route::get("order-email", 'SettingsEventController@get_order_email')->name('get_order_email');
            Route::post("order-email", 'SettingsEventController@save_order_email')->name('save_order_email');
        });
	});
});
